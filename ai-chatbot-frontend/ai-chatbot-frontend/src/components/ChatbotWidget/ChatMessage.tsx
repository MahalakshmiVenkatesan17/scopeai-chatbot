                ...
                return !inline && match ? (
                  ...
                  <code 
                    className={clsx(
                      ...
                      isAssistant ? 'bg-gray-100 text-red-600' : 'bg-white/20 text-white'
                    )}
                    {...props}
                  >
                    {children}
                ...
                return (
                  <a 
                    ...
                    className={clsx(
                      ...
                      isAssistant ? 'text-blue-600' : 'text-white font-semibold'
                    )}
                  >
                    {children}
                  </a>
              ...
              blockquote({ children }) {
                return (
                  <blockquote className={clsx(
                    ...
                    isAssistant ? 'border-gray-300 bg-gray-50' : 'border-white/30 bg-white/10'
                  )}>
                    {children}
                  </blockquote>
                );
