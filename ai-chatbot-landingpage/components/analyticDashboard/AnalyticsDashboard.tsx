...
export default function AnalyticsDashboard() {
  return (
    <div className="w-full min-h-screen bg-white dark:bg-gray-950 transition-colors">
      {/* Hero Section */}
      <section id="overview" className="relative overflow-hidden bg-gradient-to-br from-blue-50/80 via-white to-purple-50/80 dark:from-blue-950/20 dark:via-gray-950 dark:to-purple-950/20 transition-colors">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-24">
          ...
          <div>
            ...
            <h1 className="mt-6 text-4xl font-bold tracking-tight bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent sm:text-5xl lg:text-6xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a href="#" className="inline-flex items-center rounded-2xl bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 px-6 py-3 text-sm font-semibold text-white shadow-md hover:shadow-lg transition-all duration-300">
                Start Free
                <ArrowRight className="w-4 h-4 ml-2" />
              </a>
              <a href="#" className="inline-flex items-center rounded-2xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-6 py-3 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-300">
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              <div className="rounded-2xl border border-blue-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm hover:shadow-md transition-all">
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Request Visibility</p>
                <p className="mt-2 text-2xl font-bold dark:text-white">3,001+</p>
              ...
              <div className="rounded-2xl border border-blue-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm hover:shadow-md transition-all">
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Success Rate</p>
                <p className="mt-2 text-2xl font-bold text-emerald-600 dark:text-emerald-400">98.93%</p>
                <div className="flex items-center gap-1 mt-2 text-xs text-green-600 dark:text-green-400">
              ...
              <div className="rounded-2xl border border-blue-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm hover:shadow-md transition-all">
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Fast Response</p>
                <p className="mt-2 text-2xl font-bold text-sky-600 dark:text-sky-400">104ms</p>
                <div className="flex items-center gap-1 mt-2 text-xs text-green-600 dark:text-green-400">
            ...
            <div className="relative rounded-2xl border border-blue-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="flex items-center justify-between border-b border-blue-50 dark:border-gray-800 pb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="rounded-xl bg-blue-50 dark:bg-gray-800 px-3 py-1.5 text-xs font-semibold text-gray-600 dark:text-gray-300">Analytics Console</span>
                </div>
              </div>
              ...
              <div className="mt-4 rounded-2xl bg-blue-50 dark:bg-gray-800/50 p-4">
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold dark:text-white">Analytics & Usage</p>
                      <p className="text-xs text-gray-500 dark:text-gray-500">TechCorp Solutions</p>
                    </div>
                  </div>
                ...
                <div className="mt-4 grid grid-cols-2 gap-3">
                  <div className="rounded-xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-800 p-3 border-t-4 border-t-blue-500">
                    <p className="text-[10px] font-semibold uppercase text-gray-500 dark:text-gray-500">Requests</p>
                    <p className="mt-2 text-xl font-bold dark:text-white">3,001</p>
                  </div>
                  <div className="rounded-xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-800 p-3 border-t-4 border-t-emerald-500">
                    <p className="text-[10px] font-semibold uppercase text-gray-500 dark:text-gray-500">Success</p>
                    <p className="mt-2 text-xl font-bold dark:text-white">98.93%</p>
                  </div>
                </div>

                <div className="mt-4 rounded-xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-800 p-3">
                  <div className="flex items-center justify-between">
                    <p className="text-xs font-semibold text-gray-700 dark:text-gray-300">API Requests</p>
                    <p className="text-[10px] text-gray-400 dark:text-gray-500">Last 10 days</p>
                  </div>
                ...
                <div className="mt-4 grid grid-cols-3 gap-3">
                  <div className="rounded-xl border border-sky-100 dark:border-sky-900 bg-sky-50 dark:bg-sky-900/20 p-3">
                    <p className="text-[10px] uppercase text-gray-500 dark:text-gray-500">Response</p>
                    <p className="mt-2 text-sm font-bold text-sky-700 dark:text-sky-400">104ms</p>
                  </div>
                  <div className="rounded-xl border border-blue-100 dark:border-gray-700 bg-blue-50 dark:bg-gray-800 p-3">
                    <p className="text-[10px] uppercase text-gray-500 dark:text-gray-500">Docs</p>
                    <p className="mt-2 text-sm font-bold text-blue-700 dark:text-gray-300">0</p>
                  </div>
                  <div className="rounded-xl border border-emerald-100 dark:border-emerald-900 bg-emerald-50 dark:bg-emerald-900/20 p-3">
                    <p className="text-[10px] uppercase text-gray-500 dark:text-gray-500">Sessions</p>
                    <p className="mt-2 text-sm font-bold text-emerald-700 dark:text-emerald-400">0</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            <div className="group rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/80 p-6 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold dark:text-white group-hover:text-blue-600 transition-colors">Request Volume Tracking</h3>
            ...
            <div className="group rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/80 p-6 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold dark:text-white group-hover:text-blue-600 transition-colors">Active User Visibility</h3>
              <p className="mt-3 text-sm leading-6 text-gray-600 dark:text-gray-400">
            ...
            <div className="group rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/80 p-6 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold dark:text-white group-hover:text-emerald-600 transition-colors">Success Rate Monitoring</h3>
              <p className="mt-3 text-sm leading-6 text-gray-600 dark:text-gray-400">
            ...
            <div className="group rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/80 p-6 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold dark:text-white group-hover:text-amber-600 transition-colors">Cost Transparency</h3>
              <p className="mt-3 text-sm leading-6 text-gray-600 dark:text-gray-400">
          ...
          <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/80 p-6 shadow-xl sm:p-8 lg:p-10 backdrop-blur-sm">
            ...
            <div className="mt-10 overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-800 bg-blue-50 dark:bg-gray-800 shadow-lg">
              <div className="flex items-center justify-between border-b border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-900 px-5 py-4">
                ...
                <div className="hidden sm:flex items-center gap-3">
                  <span className="rounded-xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-xs font-medium text-gray-600 dark:text-gray-400">TechCorp Solutions</span>
                  <span className="rounded-xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-xs font-medium text-gray-600 dark:text-gray-400">Last 30 Days</span>
                </div>
              </div>
              ...
              <div className="p-5 sm:p-6 lg:p-8">
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold dark:text-white">Analytics & Usage</h3>
                      <p className="text-sm text-gray-500 dark:text-gray-500">Viewing data for: TechCorp Solutions</p>
                    </div>
                  </div>
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                  <div className="rounded-2xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-900 p-5 shadow-sm border-t-4 border-t-blue-500">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Total Requests</p>
                        <p className="mt-3 text-3xl font-bold tracking-tight dark:text-white">3,001</p>
                      </div>
                  ...
                  <div className="rounded-2xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-900 p-5 shadow-sm border-t-4 border-t-gray-500">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Active Users</p>
                        <p className="mt-3 text-3xl font-bold tracking-tight dark:text-white">0</p>
                      </div>
                      <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-blue-400">
                        <Users className="h-5 w-5" />
                      </div>
                  ...
                  <div className="rounded-2xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-900 p-5 shadow-sm border-t-4 border-t-emerald-500">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Success Rate</p>
                        <p className="mt-3 text-3xl font-bold tracking-tight dark:text-white">98.93%</p>
                      </div>
                  ...
                  <div className="rounded-2xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-900 p-5 shadow-sm border-t-4 border-t-orange-500">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Total Cost</p>
                        <p className="mt-3 text-3xl font-bold tracking-tight dark:text-white">$0.00</p>
                      </div>
                ...
                <div className="mt-6 grid gap-6 xl:grid-cols-2">
                  <div className="rounded-2xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-900 p-5 shadow-sm">
                    <div>
                      <h4 className="text-lg font-bold dark:text-white">API Requests Over Time</h4>
                      <p className="mt-1 text-sm text-gray-500 dark:text-gray-500">Last 10 days</p>
                    </div>
                  ...
                  <div className="rounded-2xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-900 p-5 shadow-sm">
                    <div>
                      <h4 className="text-lg font-bold dark:text-white">Token Usage</h4>
                      <p className="mt-1 text-sm text-gray-500 dark:text-gray-500">Last 0 days</p>
                    </div>
                    ...
                    <div className="mt-5 flex h-[280px] items-center justify-center rounded-xl border border-blue-50 dark:border-gray-800 bg-blue-50 dark:bg-gray-800">
                      <div className="text-center">
                        ...
                        <p className="mt-4 text-sm font-medium text-gray-500 dark:text-gray-500">No data available</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 rounded-2xl border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-900 p-5 shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-lg font-bold dark:text-white">Performance Metrics</h4>
                      <p className="text-sm text-gray-500 dark:text-gray-500">Core operational performance indicators</p>
                    </div>
                  </div>

                  <div className="mt-5 grid gap-4 lg:grid-cols-3">
                    <div className="rounded-2xl border border-sky-100 dark:border-sky-900 bg-sky-50 dark:bg-sky-900/20 p-5">
                      <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Avg Response Time</p>
                      <p className="mt-4 text-3xl font-bold tracking-tight text-sky-700 dark:text-sky-400">104.4895ms</p>
                    </div>

                    <div className="rounded-2xl border border-blue-100 dark:border-gray-800 bg-blue-50 dark:bg-gray-800 p-5">
                      <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Documents Processed</p>
                      <p className="mt-4 text-3xl font-bold tracking-tight text-blue-700 dark:text-white">0</p>
                    </div>

                    <div className="rounded-2xl border border-emerald-100 dark:border-emerald-900 bg-emerald-50 dark:bg-emerald-900/20 p-5">
                      <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Chat Sessions</p>
                      <p className="mt-4 text-3xl font-bold tracking-tight text-emerald-700 dark:text-emerald-400">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 rounded-2xl border border-blue-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-5 shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-lg font-bold dark:text-white">Summary</h4>
                      <p className="text-sm text-gray-500 dark:text-gray-500">Usage snapshot for the selected date range</p>
                    </div>
                  </div>

                  <div className="mt-5 grid gap-4 md:grid-cols-3">
                    <div className="rounded-xl border border-blue-50 dark:border-gray-800 bg-blue-50 dark:bg-gray-800 p-5">
                      <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Total Token Usage</p>
                      <p className="mt-3 text-2xl font-bold dark:text-white">0</p>
                    </div>

                    <div className="rounded-xl border border-blue-50 dark:border-gray-800 bg-blue-50 dark:bg-gray-800 p-5">
                      <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Data Tracked</p>
                      <p className="mt-3 text-2xl font-bold dark:text-white">30 days</p>
                    </div>

                    <div className="rounded-xl border border-blue-50 dark:border-gray-800 bg-blue-50 dark:bg-gray-800 p-5">
                      <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Period</p>
                      <p className="mt-3 text-2xl font-bold dark:text-white">30d</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/80 p-5 shadow-sm backdrop-blur-sm">
                <h3 className="font-bold dark:text-white">Show the product, not the admin shell</h3>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                  Use focused product mockups instead of full sidebars, filters, or internal operator controls.
                </p>
              </div>
              <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/80 p-5 shadow-sm backdrop-blur-sm">
                <h3 className="font-bold dark:text-white">Lead with outcomes</h3>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                  Market what customers gain: performance visibility, usage insights, and operational confidence.
                </p>
              </div>
              <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/80 p-5 shadow-sm backdrop-blur-sm">
                <h3 className="font-bold dark:text-white">Use real UI as proof</h3>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/80 p-8 shadow-xl lg:p-10 backdrop-blur-sm">
            ...
            <div className="mt-10 grid gap-6 lg:grid-cols-3">
              <div className="rounded-2xl border border-sky-100 dark:border-sky-900 bg-sky-50 dark:bg-sky-900/20 p-6 hover:shadow-lg transition-all">
                ...
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Avg Response Time</p>
                <p className="mt-2 text-5xl font-bold tracking-tight text-sky-700 dark:text-sky-400">104.4ms</p>
              ...
              <div className="rounded-2xl border border-blue-100 dark:border-gray-800 bg-blue-50 dark:bg-gray-800 p-6 hover:shadow-lg transition-all">
                ...
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Documents Processed</p>
                <p className="mt-2 text-5xl font-bold tracking-tight text-blue-700 dark:text-white">0</p>
                <p className="mt-3 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="rounded-2xl border border-emerald-100 dark:border-emerald-900 bg-emerald-50 dark:bg-emerald-900/20 p-6 hover:shadow-lg transition-all">
                ...
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-500">Chat Sessions</p>
                <p className="mt-2 text-5xl font-bold tracking-tight text-emerald-700 dark:text-emerald-400">0</p>
                <p className="mt-3 text-sm text-gray-600 dark:text-gray-400">
